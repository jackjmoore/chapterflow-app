...
import type { Block, Run, Align } from '../../export/htmlToBlocks'
...
/** The warning vocabulary is now the app's own — see src/shared/import.ts. */
export type LabWarningKind = ImportWarningKind
